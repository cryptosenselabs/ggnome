  ...
  return (
    <button 
      ...
      className={`flex flex-col items-center justify-center min-w-[3.5rem] py-1.5 px-2 rounded-lg border transition-all duration-200 ${
        hasUpvoted 
          ? 'bg-[#f6f9fc] border-[#e6ebf1] text-[#dc2626] cursor-default shadow-sm' 
    ...
    >
      <svg className={`w-4 h-4 mb-0.5 ${hasUpvoted ? 'text-[#dc2626]' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
