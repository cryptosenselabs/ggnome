      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a href="https://x.com/GardenGnomeCoin" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-heading transition-colors mr-2" aria-label="X (Twitter)">
